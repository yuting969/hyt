  ...
  return (
    <section className="min-h-screen flex flex-col md:flex-row justify-end items-center pt-32 pb-20 px-6 gap-8 md:gap-16">
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-thin tracking-[0.25em] mb-8 text-white/80 leading-tight">
          H<span className="tracking-[0.5em]">ihi</span>，我是<span className="font-extralight glow-text text-white">雨婷</span>
        </h1>
        <p className="text-base md:text-lg text-white/40 max-w-xl font-thin mb-10 tracking-[0.25em] uppercase">
        ...
        <div className="flex items-center gap-8 mb-14">
           ...
           <p className="text-sm md:text-base text-white/40 font-[100] tracking-[0.3em] italic">
             "讲有趣的故事，做有温度的产品。"
           </p>
        </div>
      ...
      <motion.div
        ...
        className="flex-[1.5] flex justify-end items-end"
